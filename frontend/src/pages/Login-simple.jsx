// Simple Login component without API calls - for testing
...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Mock login - this would normally call the backend API
      const mockToken = "test-jwt-token-" + Date.now();
      const mockUser = {
        id: 1,
        email: email,
        full_name:
          email === "admin@company.com" ? "Admin User" : "Regular User",
